...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='../preprocess/qm9_spectra_100.pkl', help='Path to test dataset pkl file')
    ...
    parser.add_argument('--end_idx', type=int, default=None, help='End index for the test set')
    parser.add_argument('--device', type=str, default='cuda', help='Device to use')
    parser.add_argument('--batch_size', type=int, default=32, help='Batch size for inference')
    parser.add_argument('--num_workers', type=int, default=4, help='Number of workers for data loading')
    
    # --- Sampling Parameters (Standard) ---
    parser.add_argument('--n_steps', type=int, default=10, help='Number of sampling steps')
