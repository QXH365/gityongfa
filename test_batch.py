...
def main():
    ...
    parser.add_argument('--data_path', type=str, default='QM9_all/test_data.pkl', help='Path to test dataset pkl file')
    ...
    parser.add_argument('--end_idx', type=int, default=256, help='End index for the test set')
